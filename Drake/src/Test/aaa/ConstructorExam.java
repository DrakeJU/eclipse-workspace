...
//생성자를 만드는 목적은 멤버 변수(전역변수)를 초기화시 주로 사용됩니다.	
	...
	public static void main (String[]args) {
		ConstructorExam ob1 = new ConstructorExam(); //x3
		ConstructorExam ob2 = new ConstructorExam(20);//x4
		ConstructorExam ob3 = new ConstructorExam(30);//x5
